...
type tenantReq struct{ Name, Slug, Status string }

func (h *TenantHandler) List(w http.ResponseWriter, r *http.Request) {
	v, err := h.svc.List(r.Context())
	if err != nil {
		response.Error(w, r, 500, "tenant_list_failed", err.Error())
		return
	}
...
func (h *TenantHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	t, err := h.svc.Create(r.Context(), req.Name, req.Slug)
	if err != nil {
		response.Error(w, r, 400, "tenant_create_failed", err.Error())
		return
	}
...
func (h *TenantHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		response.Error(w, r, 400, "tenant_update_failed", err.Error())
		return
	}
